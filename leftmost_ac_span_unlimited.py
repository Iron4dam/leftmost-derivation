...
def main():
    ...
    writer = SummaryWriter(log_dir='/home/xy2419/leftmost-derivation/runs/span_%.3f_entropy_%d_nt_%d_pt_%s_decay/' %(args.entropy_factor, args.nt_states, args.pt_states, args.decay))
    ...
    for i_episode in range(1, args.max_episodes+1):  # count(1):
        ...
        if success_count > 200:
            ...
            torch.save(model.state_dict(), '/home/xy2419/leftmost-derivation/saved_models/span_%.3f_entropy_%d_nt_%d_pt_%s_decay.pt' %(args.entropy_factor, args.nt_states, args.pt_states, args.decay))
