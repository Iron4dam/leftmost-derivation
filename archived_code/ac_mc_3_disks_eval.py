...
def main():
    ...
    model.load_state_dict(torch.load('/home/xy2419/leftmost-derivation/saved_models/ac_mc_0.100_entropy_6_nt_6_pt_True_decay_-0.000_0.010_-0.010_reward_3_disks_1500_steps.pt'))
    model.eval()
